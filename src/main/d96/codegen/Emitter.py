...
class Emitter():
    ...
    def getFullType(self,inType):
        ...
        if typeIn is IntType:
            ...
            return "void"
        elif typeIn is ClassType: #classname.name
            if inType.classname == "StringBuilder":
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        elif typeIn is StringType or typeIn is ClassType or typeIn is ArrayType:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitREADVAR(self, name, inType, index, frame):
        ...
        elif typeIn is ClassType or typeIn is StringType or typeIn is ArrayType:
